/*
 * softclusterlpcplexpre.h
 *
 *  Created on: 17-apr-2019
 *      Author: M. El-Kebir
 */

#ifndef SOFTCLUSTERLPCPLEXPRE_H
#define SOFTCLUSTERLPCPLEXPRE_H

#include "softclusterilp.h"
#include <ilcplex/ilocplex.h>

class SoftClusterLpCplexPre : public SoftClusterIlp
{
public:
  /// Constructor
  ///
  ...
  SoftClusterLpCplexPre(const ReadMatrix& R,
...
private:
  ...
  /// Character to precluster
  IntVector _charToPreCluster;
  ...
  /// Solver
  IloCplex _cplex;
  /// y[ii][t][j] -- posterior probability of state tree t and cluster j for SNV i
  IloNumVar3Matrix _y;
  /// d[j][p]
  IloNumVarMatrix _d;
  /// pi[j]
